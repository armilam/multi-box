...
/// Adds a registered user to the collection. If the user is already represented in the list (identified by MBUser::userId), then the user is not added. This is normally called after authenticating a user.
